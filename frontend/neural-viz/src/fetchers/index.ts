...
export interface NodeFetchers {
  activation?: (coordinate: string, modelAlias: string, inputAlias: string, workAlias?: string, pruned?: boolean) => Promise<import('./activation').ActivationData>;
  saliency_map?: (coordinate: string, modelAlias: string, inputAlias: string, workAlias?: string, pruned?: boolean) => Promise<LayerSaliencyMap>;
  weight?: (coordinate: string, modelAlias: string, workAlias?: string, pruned?: boolean) => Promise<import('./weight').WeightData>;
}
