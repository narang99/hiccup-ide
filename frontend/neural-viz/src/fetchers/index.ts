...
export interface NodeFetchers {
  activation?: (coordinate: string, modelAlias: string, inputAlias: string, workAlias?: string, graphAlias?: string) => Promise<import('./activation').ActivationData>;
  saliency_map?: (coordinate: string, modelAlias: string, inputAlias: string, workAlias?: string, graphAlias?: string) => Promise<LayerSaliencyMap>;
  weight?: (coordinate: string, modelAlias: string, workAlias?: string, graphAlias?: string) => Promise<import('./weight').WeightData>;
}
