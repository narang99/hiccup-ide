...
@router.post("/models/{model_alias}/inputs/{input_alias}/workflows/{workflow_name}/graphs/{graph_alias}/save_layer/")
def save_pruned_layer(request, model_alias: str, input_alias: str, workflow_name: str, graph_alias: str, data: BatchSaliencyMapsIn):
    ...
    for saliency_map in current_saliency_maps:
        work_saliency_map, created = WorkSaliencyMap.objects.update_or_create(
            ...
            defaults={
                ...
                'layer_name': saliency_map.layer_name,
